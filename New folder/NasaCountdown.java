...
public class NasaCountdown {
	...
	String awnser = JOptionPane.showInputDialog("Start countdown in how long?");
	
	int bobbyBoy = Integer.parseInt(awnser);
	...
	{
		JOptionPane.showMessageDialog(null, "Blas off?????");
	}
		
	//if (awnser.equals("no")) {
		//JOptionPane.showMessageDialog(null,"Alright, come again");
